...
const EditExercise = () => {
  ...
  const onSubmit = () => {
    axios.post("https://mern-stack-backend-test.herokuapp.com/exercises/update/" + id, Exericse);
  };

  useEffect(() => {
    axios
      .get("https://mern-stack-backend-test.herokuapp.com/exercises/" + id)
      .then((response) => {
        setExericse({
    ...
    axios.get("https://mern-stack-backend-test.herokuapp.com/users").then((res) => {
      console.log(res);
      res.data.map((user) => {
