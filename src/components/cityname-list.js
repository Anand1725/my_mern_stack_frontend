...
const CitynameList = () => {
  ...
  useEffect(() => {
    axios.get("https://mern-stack-backend-test.herokuapp.com/cityname/").then((response) => {
  ...
  const deleteCityname = (id) => {
    axios.delete("https://mern-stack-backend-test.herokuapp.com/cityname/" + id).then((response) => {
